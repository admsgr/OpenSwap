...
import '@openswap/opera-insider-base-plugin/contracts/interfaces/IOperaVirtualPool.sol';

/// @title Opera eternal virtual pool interface
/// @notice Used to track active liquidity in farming and distribute rewards
interface IOperaEternalVirtualPool is IOperaVirtualPool {
  error onlyPlugin();
  error onlyFarming();

  /// @notice Returns address of the OperaEternalFarming
