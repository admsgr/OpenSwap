...
interface IOperaEternalFarming {
  ...
  /// @notice enter farming for Opera LP token
  ...
  /// @notice exitFarmings for Opera LP token
  ...
  /// @notice Event emitted when a Opera LP token has been farmed
  ...
  /// @notice Event emitted when a Opera LP token exited from farming
  /// @param tokenId The unique identifier of an Opera LP token
  /// @param incentiveId The incentive in which the token is farming
