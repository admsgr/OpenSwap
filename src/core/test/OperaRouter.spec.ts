...
import { MockTimeOperaPool, TestERC20, OperaFactory, TestOperaRouter, TestOperaCallee } from '../typechain';

const tickSpacing = 60;

type ThenArg<T> = T extends PromiseLike<infer U> ? U : T;

describe('OperaPoolRouter', () => {
  ...
  let pool0: MockTimeOperaPool;
  let pool1: MockTimeOperaPool;
  ...
  let swapTargetCallee: TestOperaCallee;
  let swapTargetRouter: TestOperaRouter;
