...
const LOW_COMPILER_SETTINGS: SolcUserConfig = {
  version: '0.8.20',
  settings: {
    evmVersion: 'paris',
    optimizer: {
...
if (process.env.RUN_COVERAGE == '1') {
  ...
  HIGH_COMPILER_SETTINGS.settings.details = details;
...
export default {
  ...
  solidity: {
    ...
    overrides: {
      'contracts/OperaFactory.sol': HIGHEST_OPTIMIZER_COMPILER_SETTINGS,
      'contracts/OperaPool.sol': LOW_COMPILER_SETTINGS,
      'contracts/OperaPoolDeployer.sol': LOW_COMPILER_SETTINGS,
      'contracts/test/MockTimeOperaPoolDeployer.sol': LOW_COMPILER_SETTINGS,
    },
  },
  docgen: {
