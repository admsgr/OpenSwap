...
contract MockPoolPlugin is IOperaPlugin, IOperaDynamicFeePlugin {
  address public pool;
  ...
  function beforeInitialize(address sender, uint160 sqrtPriceX96) external override returns (bytes4) {
    ...
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.DYNAMIC_FEE)) return IOperaPlugin.beforeInitialize.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
  ...
  function afterInitialize(address sender, uint160 sqrtPriceX96, int24 tick) external override returns (bytes4) {
    ...
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.AFTER_INIT_FLAG)) return IOperaPlugin.afterInitialize.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
  ...
  function beforeModifyPosition(
    ...
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.BEFORE_POSITION_MODIFY_FLAG)) return IOperaPlugin.beforeModifyPosition.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
  ...
  function afterModifyPosition(
    ...
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.AFTER_POSITION_MODIFY_FLAG)) return IOperaPlugin.afterModifyPosition.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
  ...
  function beforeSwap(
    ...
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.BEFORE_SWAP_FLAG)) return IOperaPlugin.beforeSwap.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
  ...
  function afterSwap(
    ...
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.AFTER_SWAP_FLAG)) return IOperaPlugin.afterSwap.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
  ...
  function beforeFlash(address sender, address recipient, uint256 amount0, uint256 amount1, bytes calldata data) external override returns (bytes4) {
    ...
    IOperaPool(pool).setFee(200);
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.BEFORE_FLASH_FLAG)) return IOperaPlugin.beforeFlash.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
  ...
  function afterFlash(
    ...
    if (!Plugins.hasFlag(selectorsDisableConfig, Plugins.AFTER_FLASH_FLAG)) return IOperaPlugin.afterFlash.selector;
    return IOperaPlugin.defaultPluginConfig.selector;
  }
}
