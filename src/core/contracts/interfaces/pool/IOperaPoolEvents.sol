...
interface IOperaPoolEvents {
  ...
  /// @notice Emitted when the amount of Reserves is changed by the factory
  /// @param _r0 The amount of token0
  /// @param _r1 The amount of token1
