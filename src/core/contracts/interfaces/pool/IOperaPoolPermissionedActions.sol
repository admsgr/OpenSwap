...
interface IOperaPoolPermissionedActions {
  ...
  /// @notice Set the new Reserved amounts. Only factory owner or POOLS_ADMINISTRATOR_ROLE role
  /// @param _r0 The new reserve value
  /// @param _r1 The new reserve value
