...
import './plugin/IOperaPluginFactory.sol';
import './vault/IOperaVaultFactory.sol';

/// @title The interface for the Opera Factory
/// @dev Credit to Uniswap Labs under GPL-2.0-or-later license:
/// https://github.com/Uniswap/v3-core/tree/main/contracts/interfaces
interface IOperaFactory {
  ...
  /// @return Opera plugin factory
  function defaultPluginFactory() external view returns (IOperaPluginFactory);
  ...
  /// @return Opera vault factory
  function vaultFactory() external view returns (IOperaVaultFactory);
  ...
  /// @param token0 first token
  /// @param token1 second token
  /// @return customPool The contract address of the Opera pool
  ...
  /// @notice returns keccak256 of OperaPool init bytecode.
  /// @dev the hash value changes with any change in the pool bytecode
  /// @return Keccak256 hash of OperaPool contract init bytecode
  ...
  /// @dev updates 3rdParty Admin address
