...
/// @title Opera Migrator
/// @notice Enables migration of liquidity from Uniswap v2-compatible pairs into Opera pools
...
interface IV3Migrator is IMulticall, ISelfPermit, IPoolInitializer {
    ...
    /// @notice Migrates liquidity to Opera by burning v2 liquidity and minting a new position for Opera
