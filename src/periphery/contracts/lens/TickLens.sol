...
import '@openswap/opera-insider-core/contracts/libraries/TickTree.sol';

import '../interfaces/ITickLens.sol';

/// @title Opera Insider 1.1 Tick Lens contract
...
contract TickLens is ITickLens {
    ...
    function getPopulatedTicksInWord(
        ...
        // fetch bitmap
        uint256 bitmap = IOperaPool(pool).tickTable(tickTableIndex);
        unchecked {
    ...
    function getClosestActiveTicks(
        ...
        uint32 tickTreeRoot = IOperaPool(pool).tickTreeRoot();
    ...
    function getNextActiveTicks(
        ...
        (uint256 liquidityGross, int128 liquidityNet, int24 previousTick, int24 nextTick, , ) = IOperaPool(pool)
            .ticks(currentTick);
