...
/// @title Opera Insider 1.1 NFT positions
/// @notice Wraps Opera positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
    ...
    // details about the Opera position
    struct Position {
    ...
    constructor(
        ...
        ERC721Permit('Opera Positions NFT-V2', 'ALGB-POS', '2')
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        IOperaPool pool = IOperaPool(_getPoolById(poolId));
    ...
    function collect(
        ...
        Position storage position = _positions[params.tokenId];
        IOperaPool pool = IOperaPool(_getPoolById(position.poolId));
    ...
    function setFarmingCenter(address newFarmingCenter) external override {
        require(IOperaFactory(factory).hasRoleOrOwner(NONFUNGIBLE_POSITION_MANAGER_ADMINISTRATOR_ROLE, msg.sender));
