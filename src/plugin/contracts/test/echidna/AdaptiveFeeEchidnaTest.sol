...
contract AdaptiveFeeEchidnaTest {
  ...
  function checkFeeInvariants(
    ...
    unchecked {
      OperaFeeConfiguration memory feeConfig = OperaFeeConfiguration(alpha1, alpha2, beta1, beta2, gamma1, gamma2, baseFee);
  ...
  function checkFeeConfigPackedCorrectness(
    ...
    OperaFeeConfigurationU144 feeConfig = OperaFeeConfiguration(alpha1, alpha2, beta1, beta2, gamma1, gamma2, baseFee).pack();
