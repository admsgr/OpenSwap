...
contract MockTimeOperaBasePluginV1 is OperaBasePluginV1 {
  using VolatilityOracle for VolatilityOracle.Timepoint[UINT16_MODULO];

  // Monday, October 5, 2020 9:00:00 AM GMT-05:00
  uint256 public time = 1601906400;

  constructor(address _pool, address _factory, address _pluginFactory) OperaBasePluginV1(_pool, _factory, _pluginFactory) {
    //
  }
