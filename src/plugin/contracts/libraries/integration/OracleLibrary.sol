...
/// @notice Provides functions to integrate with Opera pool TWAP VolatilityOracle
library OracleLibrary {
  /// @notice Fetches time-weighted average tick using Opera VolatilityOracle
  ...
  function isOracleConnectedToPool(address oracleAddress, address poolAddress) internal view returns (bool connected) {
    IOperaPool pool = IOperaPool(poolAddress);
