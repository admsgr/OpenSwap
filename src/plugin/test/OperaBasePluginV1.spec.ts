...
import { MockPool, MockTimeOperaBasePluginV1, MockTimeDSFactory, MockTimeVirtualPool } from '../typechain';

import snapshotGasCost from './shared/snapshotGasCost';

describe('OperaBasePluginV1', () => {
  let wallet: Wallet, other: Wallet;

  let plugin: MockTimeOperaBasePluginV1; // modified plugin
  let mockPool: MockPool; // mock of OperaPool
  ...
  beforeEach('deploy test OperaBasePluginV1', async () => {
  ...
  describe('OperaBasePluginV1 external methods', () => {
