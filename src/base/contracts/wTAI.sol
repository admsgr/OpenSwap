...
contract VivaForeverTokenAI is ERC20, ERC20Permit, ERC20Votes, Ownable {
  mapping(uint => address) public crossChain;

  constructor(string memory _name, string memory _symbol, uint256 _amount) ERC20(_name, _symbol) ERC20Permit(_name) {
