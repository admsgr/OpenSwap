...
export async function mkRoot(phrase: string) {
  ...
  const FEETO_AMOUNT = expandTo18Decimals(100_000_000);
...
export const phrase = 'amount pottery mammal state foster problem connect salad north midnight carbon rhythm';
export const makeRoot = mkRoot(phrase);
export const name = 'Viva Forever Token AI';
export const symbol = 'wTAI';
export const amount = expandTo18Decimals(100_000_000);
