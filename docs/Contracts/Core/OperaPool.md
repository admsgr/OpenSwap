...
Opera concentrated liquidity pool

This contract is responsible for liquidity positions, swaps and flashloans

*Developer note: Version: Opera Insider 1.1*

**Inherits:** [OperaPoolBase](base/OperaPoolBase.md) [TickStructure](base/TickStructure.md) ReentrancyGuard [Positions](base/Positions.md) SwapCalculation [ReservesManager](base/ReservesManager.md)
...
*Developer note: The caller of this method receives a callback in the form of [IOperaMintCallback#operaMintCallback](interfaces/callback/IOperaMintCallback.md#operaMintCallback)
...
*Developer note: The caller of this method receives a callback in the form of [IOperaSwapCallback#operaSwapCallback](interfaces/callback/IOperaSwapCallback.md#operaSwapCallback)*
...
*Developer note: The caller of this method receives a callback in the form of [IOperaFlashCallback#operaFlashCallback](interfaces/callback/IOperaFlashCallback.md#operaFlashCallback)
