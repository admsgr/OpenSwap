...
The interface for the Opera Factory
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| deployer | address | The corresponding custom deployer contract |
| token0 | address | The first token of the pool by address sort order |
| token1 | address | The second token of the pool by address sort order |
| pool | address | The address of the created pool |
...
```solidity
function defaultPluginFactory() external view returns (contract IOperaPluginFactory)
```
**Selector**: `0xd0ad2792`
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | contract IOperaPluginFactory | Opera plugin factory |

### vaultFactory

```solidity
function vaultFactory() external view returns (contract IOperaVaultFactory)
```
**Selector**: `0xd8a06f73`
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | contract IOperaVaultFactory | Opera vault factory |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| customDeployer | address | the address of custom plugin deployer |
| token0 | address | first token |
| token1 | address | second token |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| customPool | address | The pool address |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | bytes32 | Keccak256 hash of OperaPool contract init bytecode |
