...
Opera Insider 1.1 NFT positions

Wraps Opera positions in the ERC721 non-fungible token interface
...
| deployer | address | The address of the custom pool deployer |
