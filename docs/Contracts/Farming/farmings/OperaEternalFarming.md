...
Opera Insider 1.1  eternal (v2-like) farming

Manages rewards and virtual pools

**Inherits:** [IOperaEternalFarming](../interfaces/IOperaEternalFarming.md)
## Modifiers
### onlyIncentiveMaker
...
### incentives
```solidity
mapping(bytes32 => struct OperaEternalFarming.Incentive) incentives
```
**Selector**: `0x60777795`
...
### farms
```solidity
mapping(uint256 => mapping(bytes32 => struct OperaEternalFarming.Farm)) farms
```
**Selector**: `0x27e6a99a`
...
```solidity
constructor(contract IOperaPoolDeployer _deployer, contract INonfungiblePositionManager _nonfungiblePositionManager) public
```
...
| ---- | ---- | ----------- |
| _deployer | contract IOperaPoolDeployer | pool deployer contract address |
...
enter farming for Opera LP token
