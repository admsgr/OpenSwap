...
Opera main farming contract interface
...
```solidity
function eternalFarming() external view returns (contract IOperaEternalFarming)
```
**Selector**: `0xde2356d1`
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | contract IOperaEternalFarming |  |
...
```solidity
function incentiveKeys(bytes32 incentiveId) external view returns (contract IERC20Minimal rewardToken, contract IERC20Minimal bonusRewardToken, contract IOperaPool pool, uint256 nonce)
```
**Selector**: `0x8c27f1f6`
